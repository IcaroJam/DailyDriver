...
<nav>
	<div title="Settings~" class="roundIcons configIcon" class:toggled-config={configShow} role="button" tabindex="0" on:click={toggleConfig} on:keypress={toggleConfig}>
